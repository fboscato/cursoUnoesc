...
const p1 = new Pessoa('Juliano', 'Pilger', 30); //construtor (Pessoa), é a função que construiu o objeto 
p1.numero = 34;
console.log(p1);*/
...
const pessoa1 = new Pessoa('Juliano', 'Pilger'); //instanciar uma pessoa = criar um objeto a partir da classe (new)
console.log(pessoa1);
pessoa1.falar();
