...
const produtosMaior5000 = produtos.filter((produtosMaior5000) => {
    return produtosMaior5000.preco > 5000;
});
console.log('Produtos com preço acima de R$5000,00', produtosMaior5000.map((produtosMaior5000) => produtosMaior5000.nome));
