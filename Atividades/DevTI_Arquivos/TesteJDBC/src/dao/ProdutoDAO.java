...
public class ProdutoDAO implements IProdutoDAO {
	...
	@Override
	public List<Produto> listarTodos() throws DbException {
	...
	@Override
	public void adicionar(Produto p) throws DbException {
		conexao = FabricaConexao.getConexao();
	...
	@Override
	public void alterar(Produto p) throws DbException {
		conexao = FabricaConexao.getConexao();
	...
	@Override
	public Produto buscarPorId(Integer id) throws DbException {
		conexao = FabricaConexao.getConexao();
		Produto p = null;
